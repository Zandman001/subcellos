pub struct AP { a1: f32, zm1: f32 }
impl AP {
  pub fn new() -> Self { Self { a1: 0.0, zm1: 0.0 } }
  #[inline] pub fn set_fc(&mut self, fc: f32, sr: f32) {
...
pub struct Phaser { ap: [AP; 4], phase: f32 }
impl Phaser {
  pub fn new() -> Self { Self { ap: [AP::new(), AP::new(), AP::new(), AP::new()], phase: 0.0 } }
  #[inline]
  pub fn process_one(&mut self, l: f32, r: f32, sr: f32, rate_hz: f32, depth: f32, mix: f32) -> (f32, f32) {
