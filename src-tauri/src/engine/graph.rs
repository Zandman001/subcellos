...
impl Part {
  pub fn new(sr: f32, poly: usize, idx: usize) -> Self {
    ...
    let mut p = Self { voices, sr, idx, next_voice: 0,
      ...
      fx1_lfo: 0.0, fx2_lfo: 0.0, paths: ParamPaths::new(idx), lfo_phase: 0.0, lfo_hold: 0.0, lfo_decim: 0, modf_last: ModFrame { cents_a:0.0, cents_b:0.0, lvl_a:0.0, lvl_b:0.0, filt1:0.0, filt2:0.0 },
